...
client.videos.detail(videoId, data=>{
    ...
    video_files.forEach(item =>{
       ...
       <span class="label-large tralling-text">${width} x ${height}</span>
    ...
    <div class="datails-banner" style="aspect-ratio: ${width}/ ${height};">
                <video src="${link}" controls class="img-cover" poster= "${image}" type="${file_type}" data-video></video>
            </div>
